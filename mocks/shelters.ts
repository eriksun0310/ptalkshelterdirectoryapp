...
export const mockShelters: ShelterDetail[] = [
  {
    ...
    rules: [
      '為了狗狗們的健康，請穿著乾淨衣褲、運動鞋或雨鞋前往。',
      '服務期間，若要離開園區，需告知園區負責人後才能離開。',
      '請大家不要獨自進入狗的範圍，避免誤入地盤。',
      '進入狗舍後，請勿讓狗兒衝出，避免狗群打架。',
      '不要對著狗狗大吼大叫，避免狗狗受到驚嚇。',
      '請勿私自餵食園區狗狗，若遇到特殊狀況請洽園區負責人員。',
      '互動時，請多注意狗狗神情與肢體語言，必要時與狗狗保持安全距離。',
      '園區有提供手套，如須使用請洽園區負責人員。',
      '如有攜帶物品（如：包包、保溫瓶等）請集中放置，避免狗狗誤食。',
      '怕園區志工在忙無法即時照顧到受傷的朋友，請自備簡易醫藥用品。',
      '請記得帶一套乾淨衣物，志工服務完成後可替換髒衣服。',
    ],
  },
  {
    id: '2',
